...
export function runningBuildsUrl(org: string, project: string): string {
  return `https://dev.azure.com/${org}/${encodeURIComponent(project)}/_apis/build/builds?statusFilter=inProgress&api-version=${ADO_API_VERSION}`;
}
